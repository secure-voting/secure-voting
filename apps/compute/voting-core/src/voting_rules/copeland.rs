...
pub type CopelandIRule = VotingRule<CopelandIScorer, MajorityDecider, FallthroughTieBreaker>;
...
pub type CopelandIIRule = VotingRule<CopelandIIScorer, MajorityDecider, FallthroughTieBreaker>;

/// Copeland III Voting rule type.
///
/// Each candidate's score is the total margin of win in head-to-head comparisons.
pub type CopelandIIIRule = VotingRule<CopelandIIIScorer, MajorityDecider, FallthroughTieBreaker>;
