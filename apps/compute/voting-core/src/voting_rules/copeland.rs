...
pub type CopelandIRule<TB = FallthroughTieBreaker> =
    VotingRule<CopelandIScorer, MajorityDecider<usize>, TB>;
...
pub type CopelandIIRule<TB = FallthroughTieBreaker> =
    VotingRule<CopelandIIScorer, MajorityDecider<isize>, TB>;
...
pub type CopelandIIIRule<TB = FallthroughTieBreaker> =
    VotingRule<CopelandIIIScorer, MajorityDecider<isize>, TB>;
