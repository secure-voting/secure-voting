...
use crate::{
    decider::maxscore::MaxScoreDecider, models::ranking::RankingBallot, scorer::borda::BordaScorer,
...
pub type BordaRule = BordaRuleWith<FallthroughTieBreaker, RankingBallot>;
